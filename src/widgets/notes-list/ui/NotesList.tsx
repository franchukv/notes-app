    ...
    <div className="w-full py-5 lg:max-w-72.5 lg:min-w-72.5 lg:border-r lg:border-neutral-200">
      <div className="custom-container">
        <div className="flex flex-col gap-4">
          <Button className="fixed bottom-18 right-4 z-1 sm:bottom-26.5 sm:right-8 max-sm:h-12 max-sm:w-12 max-lg:h-16 max-lg:w-16 max-lg:p-0 max-lg:rounded-full max-lg:shadow-[0_7px_11px_0_rgba(202,207,216,0.7)] lg:static">
