...
export const NavigationButton = ({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          'w-full py-2.5 px-3 flex items-center gap-2 text-preset-4 rounded-lg transition-all duration-300 hover:bg-neutral-100 active:bg-neutral-100 hover:text-neutral-600 active:text-neutral-600',
          className,
