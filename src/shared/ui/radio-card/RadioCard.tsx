...
export const RadioCard = ({
  ...
  return (
    <label htmlFor={id} className="w-full flex relative">
      ...
      />
      <span
        className="w-full p-4 flex items-center gap-4 cursor-pointer bg-white border border-neutral-200 rounded-xl outline-2 outline-offset-2 outline-transparent shadow-[0_1px_2px_0_rgba(10,13,20,0.03)] after:content-[''] after:min-w-4 after:w-4 after:h-4 after:ml-auto after:block after:rounded-full after:border-2 after:border-neutral-200 not-focus:hover:bg-neutral-50 peer-checked:bg-neutral-100 peer-focus-visible:outline-neutral-400 peer-disabled:pointer-events-none peer-disabled:bg-neutral-50 peer-disabled:opacity-50 peer-checked:after:border-4 peer-checked:after:border-blue-500 dark:bg-neutral-950 dark:border-neutral-800 dark:after:border-neutral-600 dark:peer-checked:bg-neutral-800 dark:peer-disabled:bg-neutral-700 dark:not-focus:hover:bg-neutral-800
			"
      >
        <span className="min-w-10 w-10 h-10 flex items-center justify-center bg-white text-neutral-950 border border-neutral-200 rounded-xl [&>svg]:h-6 [&>svg]:w-6 dark:border-neutral-800 dark:text-white dark:bg-neutral-950">
          {icon}
        </span>
