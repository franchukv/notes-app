...
const classNames: ClassNamesConfig<Option, true, GroupBase<Option>> = {
  container: () => 'w-full text-neutral-950 text-preset-6! sm:text-preset-5!',
  control: ({ isFocused }) =>
    cn(
      'min-h-0! border! rounded-lg! shadow-[0_1px_2px_0_rgba(10,13,20,0.03)]! outline-2! outline-offset-2!',
      isFocused
        ? 'border-neutral-950! outline-neutral-400!'
        : 'border-neutral-300! outline-transparent! hover:bg-neutral-50!',
    ),
  valueContainer: () => 'p-1!',
  multiValue: () =>
    'py-0.5! pl-1.5! pr-1! flex items-center gap-1 bg-neutral-200! rounded-sm!',
  multiValueLabel: () => 'p-0! text-preset-6!',
  multiValueRemove: () =>
    'p-0! cursor-pointer bg-transparent! hover:text-red-500',
  indicatorsContainer: () => '',
  indicatorSeparator: () => 'bg-neutral-300!',
  loadingIndicator: () => 'text-neutral-500!',
  clearIndicator: () =>
    'p-2! text-neutral-500! cursor-pointer hover:text-red-500!',
  dropdownIndicator: ({ selectProps }) =>
    cn(
      'p-2! text-neutral-500! cursor-pointer transition-all! duration-150! hover:text-neutral-950!',
      selectProps.menuIsOpen && 'text-neutral-950! scale-y-[-1]',
    ),
  menu: () =>
    'rounded-lg! shadow-[0_1px_2px_0_rgba(10,13,20,0.03)]! border border-neutral-300 overflow-hidden!',
  menuList: () => 'p-0!',
  option: ({ isFocused }) =>
    cn('p-2! cursor-pointer!', isFocused && 'bg-neutral-100!'),
};
